...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "tipoEmpleado")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatTipoEmpleado extends BaseCatalogoModel implements Unicable, Idable {
	...
	public void setTipoEmpleado(Integer idTipoEmpleado) {
