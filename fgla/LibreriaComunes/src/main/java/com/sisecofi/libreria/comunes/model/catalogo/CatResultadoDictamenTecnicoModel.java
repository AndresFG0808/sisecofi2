...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "resultadoDictamenTecnico")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatResultadoDictamenTecnicoModel extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdResultadoDictamenTecnico() {
		return idResultadoDictamenTecnico;
	}

	public void setIdResultadoDictamenTecnico(Integer idGiroEmpresarial) {
		this.idResultadoDictamenTecnico = idGiroEmpresarial;
	}
