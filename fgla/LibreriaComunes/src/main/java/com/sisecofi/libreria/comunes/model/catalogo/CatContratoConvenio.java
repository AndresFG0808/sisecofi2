...
@CatalogoGeneral
public class CatContratoConvenio extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdContratoConvenio() {
		return idContratoConvenio;
	}

	public void setIdContratoConvenio(Integer idContratoConvenio) {
		this.idContratoConvenio = idContratoConvenio;
	}
