...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "tipoReintegro")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatTipoReintegro extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdTipoReintegro() {
		return idTipoReintegro;
	}

	public void setIdTipoReintegro(Integer idTipoReintegro) {
		this.idTipoReintegro = idTipoReintegro;
	}
