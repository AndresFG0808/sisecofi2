...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "contratoVigente")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatContratoVigente extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdContratoVigente() {
		return idContratoVigente;
	}

	public void setIdContratoVigente(Integer idContratoVigente) {
		this.idContratoVigente = idContratoVigente;
	}
