...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "acuerdoPago")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatAcuerdoPago extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdAcuerdoPago() {
		return idAcuerdoPago;
	}

	public void setIdAcuerdoPago(Integer idAcuerdoPago) {
