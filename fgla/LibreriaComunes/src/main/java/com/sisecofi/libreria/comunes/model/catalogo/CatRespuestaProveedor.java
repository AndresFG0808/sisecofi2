...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "respuestaProveedor")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatRespuestaProveedor extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdInvestigacionMercado() {
		return idInvestigacionMercado;
	}

	public void setIdInvestigacionMercado(Integer idInvestigacionMercado) {
		this.idInvestigacionMercado = idInvestigacionMercado;
	}
