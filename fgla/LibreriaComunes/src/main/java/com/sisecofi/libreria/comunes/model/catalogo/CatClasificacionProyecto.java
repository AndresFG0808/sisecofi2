...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "clasificacionProyecto")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatClasificacionProyecto extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdClasificacionProyecto() {
		return idClasificacionProyecto;
	}

	public void setIdClasificacionProyecto(Integer idClasificacionProyecto) {
		this.idClasificacionProyecto = idClasificacionProyecto;
	}
