...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "estatusNotaCredito")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatEstatusNotaCredito extends BaseCatalogoModel implements Unicable, Idable {
	...
	private Integer idEstatusNotaCredito;
	...
	public Integer getIdEstatusNotaCredito() {
		return idEstatusNotaCredito;
	}

	public void setIdEstatusNotaCredito(Integer idEstatusNotaCredito) {
		this.idEstatusNotaCredito = idEstatusNotaCredito;
	}
