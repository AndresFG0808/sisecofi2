...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "dominiosTecnologicos")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatDominiosTecnologicos extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdDominiosTecnologicos() {
		return idDominiosTecnologicos;
	}

	public void setIdDominiosTecnologicos(Integer idDominiosTecnologicos) {
		this.idDominiosTecnologicos = idDominiosTecnologicos;
	}
