...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "correo")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatCorreo extends BaseCatalogoModel implements Unicable, Idable {
	...
	@CampoFront(nombre = "Nombre", tipoDato = "String", orden = 0, tamanio = "150")
	...
	@CampoFront(nombre = "Asunto", tipoDato = "String", orden = 3, tamanio = "300")
	@Column(name = "asunto", length = 300)
	@CampoReporte(nombre = "Asunto")
	...
	@CampoFront(nombre = "Contenido", tipoDato = "String", orden = 2, tamanio = "300")
	@Column(name = "contenido", length = 300)
	@CampoReporte(nombre = "Contenido")
	@Pattern(regexp = ErroresEnum.MensajeValidation.REGEX_SOLO_TEXTO_300, message = ErroresEnum.MensajeValidation.MENSAJE_REGEX_SOLO_TEXTO_300)
	private String contenido;
	
	@CampoFront(nombre = "Destinatario", tipoDato = "String", orden = 4, tamanio = "300")
	@Pattern(regexp = ErroresEnum.MensajeValidation.REGEX_SOLO_TEXTO_300, message = ErroresEnum.MensajeValidation.MENSAJE_REGEX_SOLO_TEXTO_300)
	@Column(name = "destinatario", length = 300)
	@CampoReporte(nombre = "Destinatario")
	private String destinatario;
	
	@CampoFront(nombre = "CC", tipoDato = "String", orden = 1, tamanio = "300")
	@Column(name = "cc", length = 300)
	@Pattern(regexp = ErroresEnum.MensajeValidation.REGEX_SOLO_TEXTO_300, message = ErroresEnum.MensajeValidation.MENSAJE_REGEX_SOLO_TEXTO_300)
	@CampoReporte(nombre = "CC")
	private String cc;
