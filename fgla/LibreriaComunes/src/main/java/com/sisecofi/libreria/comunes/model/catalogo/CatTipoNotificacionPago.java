...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "tipoNotificacionPago")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatTipoNotificacionPago extends BaseCatalogoModel implements Unicable, Idable {
  ...
  public Integer getIdTipoNotificacionPago() {
    return idTipoNotificacionPago;
  }

  public void setIdTipoNotificacionPago(Integer idTipoNotificacionPago) {
    this.idTipoNotificacionPago = idTipoNotificacionPago;
  }
