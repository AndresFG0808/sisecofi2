...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "periodoControlMes")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatPeriodoControlMes extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdPeriodoControlMes() {
		return idPeriodoControlMes;
	}

	public void setIdPeriodoControlMes(Integer idPeriodoControlMes) {
		this.idPeriodoControlMes = idPeriodoControlMes;
	}
