...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "giroEmpresarial")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatGiroEmpresarial extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdGiroEmpresarial() {
		return idGiroEmpresarial;
	}

	public void setIdGiroEmpresarialModel(Integer idGiroEmpresarial) {
