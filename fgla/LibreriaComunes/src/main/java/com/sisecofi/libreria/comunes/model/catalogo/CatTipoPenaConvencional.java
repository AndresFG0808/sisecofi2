...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "tipoPenaConvencional")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatTipoPenaConvencional extends BaseCatalogoModel implements Unicable, Idable {
	...
	private Integer idTipoPenaConvencional;
	...
	public Integer getIdTipoPenaConvencional() {
		return idTipoPenaConvencional;
	}

	public void setIdPenaConvencional(Integer idTipoPenaConvencional) {
		this.idTipoPenaConvencional = idTipoPenaConvencional;
	}
