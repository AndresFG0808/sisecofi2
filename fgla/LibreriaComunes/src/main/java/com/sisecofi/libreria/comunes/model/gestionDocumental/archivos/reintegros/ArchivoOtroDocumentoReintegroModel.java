...
@Entity
@Table(name = ConstantesComunes.PREFIX_TRAB + "archivo_otro_documento_reintegro")
@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
@Getter
@Setter
@JsonTypeName("tipoReintegro")
@EqualsAndHashCode(callSuper = false)
public class ArchivoOtroDocumentoReintegroModel extends Archivo {
