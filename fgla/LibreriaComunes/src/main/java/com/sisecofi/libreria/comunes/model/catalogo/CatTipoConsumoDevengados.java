...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "tipoConsumoDevengados")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatTipoConsumoDevengados extends BaseCatalogoModel implements Unicable, Idable {
	...
	private Integer idTipoConsumoDevengados;
	...
	public Integer getIdTipoConsumoDevengados() {
		return idTipoConsumoDevengados;
	}

	public void setIdTipoConsumoDevengados(Integer idTipoConsumoDevengados) {
		this.idTipoConsumoDevengados = idTipoConsumoDevengados;
	}
