...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "fondeoContrato")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatFondeoContrato extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdFondeoContrato() {
		return idFondeoContrato;
	}

	public void setIdFondeoContrato(Integer idFondeoContrato) {
		this.idFondeoContrato = idFondeoContrato;
	}
