...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "tituloServicio")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatTituloServicio extends BaseCatalogoModel implements Unicable, Idable {
	...
	@CampoFront(nombre = "NombreCorto", tipoDato = "String", orden = 3, tamanio = "300")
	@Column(name = "nombreCorto", length = 300)
	@CampoReporte(nombre = "NombreCorto")
	@Pattern(regexp = ErroresEnum.MensajeValidation.REGEX_SOLO_TEXTO_300, message = ErroresEnum.MensajeValidation.MENSAJE_REGEX_SOLO_TEXTO_300)
	private String nombreCorto;

	public Integer getIdTituloServicio() {
		return idTituloServicio;
	}

	public void setIdTituloServicio(Integer idTituloServicio) {
		this.idTituloServicio = idTituloServicio;
	}
