...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "periodoControlAnio")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatPeriodoControlAnio extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdPeriodoControlAnio() {
		return idPeriodoControlAnio;
	}

	public void setIdPeriodoControlAnio(Integer idPeriodoControlAnio) {
		this.idPeriodoControlAnio = idPeriodoControlAnio;
	}
