...
@Entity
@Table(name = ConstantesComunes.PREFIX_TRAB + "archivo_otro_documento_fase_convenio")
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
@Getter
@Setter
@JsonTypeName("tipoFaseConvenio")
@EqualsAndHashCode(callSuper = false)
public class ArchivoOtroDocumentoFaseConvenioModel extends Archivo {
