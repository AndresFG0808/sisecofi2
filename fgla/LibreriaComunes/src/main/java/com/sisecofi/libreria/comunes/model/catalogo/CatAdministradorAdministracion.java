...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "administradorAdministracion")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@FilterDef(name = "estatusAdminAdministracion", defaultCondition = "estatus = true")
@CatalogoComplementario
public class CatAdministradorAdministracion extends BaseCatalogoModel implements Unicable, Idable, AdministradorBase {
	...
	private Integer idAdministradorAdministracion;
	...
	public Integer getIdAdministradorAdministracion() {
		return idAdministradorAdministracion;
	}

	public void setIdAdministradorAdministracion(Integer idAdministradorAdministracion) {
		this.idAdministradorAdministracion = idAdministradorAdministracion;
	}
	...
	public Integer getIdAdministrador() {
		return getIdAdministradorAdministracion();
	}
