...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "administradorCentral")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@FilterDef(name = "estatusAdminCentral", defaultCondition = "estatus = true")
@CatalogoComplementario
public class CatAdministradorCentral extends BaseCatalogoModel implements Unicable, Idable, AdministradorBase  {
	...
	@CampoFront(nombre = "administrador", tipoDato = "String", orden = 0)
	@Column(name = "administrador", length = 150)
	@CampoUnico
	@CampoReporte(nombre = "Nombre completo")
	private String administrador;

	@CampoFront(nombre = "Fecha inicio vigencia", tipoDato = "Date", orden = 1)
	@Column(name = "fechaInicioVigencia")
	@CampoReporte(nombre = "Fecha inicio de vigencia")
	private LocalDateTime fechaInicioVigencia;

	@CampoFront(nombre = "Fecha fin vigencia", tipoDato = "Date", orden = 2)
	...
	@CampoFront(nombre = "catalogo-administración-central", tipoDato = "catalogo", orden = 8, id = true)
	@JsonBackReference
	...
	public Integer getIdAdministradorCentral() {
		return idAdministradorCentral;
	}

	public void setIdAdministradorCentral(Integer idAdministradorCentral) {
		this.idAdministradorCentral = idAdministradorCentral;
	}
	...
	public Integer getIdAdministrador() {
		return getIdAdministradorCentral();
	}
