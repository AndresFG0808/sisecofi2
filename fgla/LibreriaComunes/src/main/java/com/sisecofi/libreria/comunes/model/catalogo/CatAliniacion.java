...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "aliniacion")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoComplementario
public class CatAliniacion extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdAliniacion() {
		return idAliniacion;
	}

	public void setIdAliniacion(Integer idAliniacion) {
		this.idAliniacion = idAliniacion;
	}
