...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "desgloce")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatDesgloce extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdDesgloce() {
		return idDesgloce;
	}

	public void setIdDesgloce(Integer idDesgloce) {
