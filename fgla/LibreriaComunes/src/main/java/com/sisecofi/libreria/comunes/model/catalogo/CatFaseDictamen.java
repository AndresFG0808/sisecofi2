...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "faseDictamen")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatFaseDictamen extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdFaseDictamen() {
		return idFaseDictamen;
	}

	public void setIdFaseDictamen(Integer idFaseProyecto) {
		this.idFaseDictamen = idFaseProyecto;
	}
