...
@Entity
@Table(name = ConstantesComunes.PREFIX_TRAB + "archivo_otro_documento_dictamen")
@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
@Getter
@Setter
@JsonTypeName("tipoDictamen")
@EqualsAndHashCode(callSuper = false)
public class ArchivoOtroDocumentoDictamenModel extends Archivo {
	...
	public String getIdDictamenAux() {
		return "" + idDictamen;
	}
