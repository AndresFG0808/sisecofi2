...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "estatusDictamen")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatEstatusDictamen extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdEstatusDictamen() {
		return idEstatusDictamen;
	}

	public void setIdEstatusDictamen(Integer idEstatusDictamen) {
		this.idEstatusDictamen = idEstatusDictamen;
	}
