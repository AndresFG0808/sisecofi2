...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "estatusEstimacion")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatEstatusEstimacion extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdEstatusEstimacion() {
		return idEstatusEstimacion;
	}

	public void setIdEstatusEstimacion(Integer idEstatusEstimacion) {
