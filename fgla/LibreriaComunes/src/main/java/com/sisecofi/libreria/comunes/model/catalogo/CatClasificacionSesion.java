...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "clasificacionSesion")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatClasificacionSesion extends BaseCatalogoModel implements Unicable, Idable {
	...
	private Integer idClasificacionSesion;
	...
	public Integer getIdClasificacionSesion() {
		return idClasificacionSesion;
	}

	public void setIdClasificacionSesion(Integer idClasificacionSesion) {
		this.idClasificacionSesion = idClasificacionSesion;
	}
