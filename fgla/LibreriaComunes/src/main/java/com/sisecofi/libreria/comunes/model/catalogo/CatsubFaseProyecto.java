...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "subFaseProyecto")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatsubFaseProyecto extends BaseCatalogoModel implements Unicable, Idable {
	...
	private Integer idSubFaseProyecto;

	@ManyToOne
	@JoinColumn(name = "id_fase_proyecto", foreignKey = @ForeignKey(name = "FK_fase_proyecto"), nullable = false)
	...
	public Integer getIdSubFaseProyecto() {
		return idSubFaseProyecto;
	}

	public void setIdSubFaseProyecto(Integer idSubFaseProyecto) {
		this.idSubFaseProyecto = idSubFaseProyecto;
	}

	public CatFaseProyecto getCatFaseProyecto() {
		return catFaseProyecto;
	}

	public void setCatFaseProyecto(CatFaseProyecto catFaseProyecto) {
		this.catFaseProyecto = catFaseProyecto;
	}
