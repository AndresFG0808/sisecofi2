...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "estatusRcp")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatEstatusRcp extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdEstatusRcp() {
		return idEstatusRcp;
	}

	public void setIdEstatusRcp(Integer idEstatusRcp) {
		this.idEstatusRcp = idEstatusRcp;
	}
