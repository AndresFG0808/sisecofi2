...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "convenioColaboracionReporte")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatConvenioColaboracionReporte extends BaseCatalogoModel implements Unicable, Idable {
	...
	private Integer idConvenioColaboracionReporte;
	...
	public Integer getIdConvenioColaboracionReporte () {
		return idConvenioColaboracionReporte ;
	}

	public void setIdConvenioColaboracionReporte (Integer idConvenioColaboracionReporte ) {
		this.idConvenioColaboracionReporte  = idConvenioColaboracionReporte ;
	}
