...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "tipoPenaContractual")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatTipoPenaContractual extends BaseCatalogoModel implements Unicable, Idable {
	...
	private Integer idTipoPenaContractual;
	...
	public Integer getIdTipoPenaContractual() {
		return idTipoPenaContractual;
	}

	public void setIdPenaContractual(Integer idTipoPenaContractual) {
		this.idTipoPenaContractual = idTipoPenaContractual;
	}
