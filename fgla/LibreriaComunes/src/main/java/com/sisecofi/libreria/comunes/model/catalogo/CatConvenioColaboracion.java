...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "convenioColaboracion")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatConvenioColaboracion extends BaseCatalogoModel implements Unicable, Idable {
	...
	public Integer getIdConvenioColaboracion () {
		return idConvenioColaboracion ;
	}

	public void setIdConvenioColaboracion (Integer idConvenioColaboracion ) {
		this.idConvenioColaboracion  = idConvenioColaboracion ;
	}
