...
@Entity
@Table(name = ConstantesComunes.PREFIX_CAT + "estatusTituloServicio")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = false)
@JsonIgnoreProperties(ignoreUnknown = true)
@CatalogoGeneral
public class CatEstatusTituloServicio extends BaseCatalogoModel implements Unicable, Idable {
	...
	@CampoFront(nombre = "Color semaforo estatus", tipoDato = "String", orden = 3, tamanio = "300")
	@Column(name = "colorSemaforoEstatus", length = 300)
	@CampoReporte(nombre = "Color semaforo estatus")
	@Pattern(regexp = ErroresEnum.MensajeValidation.REGEX_SOLO_TEXTO_300, message = ErroresEnum.MensajeValidation.MENSAJE_REGEX_SOLO_TEXTO_300)
	private String colorSemaforoEstatus;

	public Integer getIdEstatusTituloServicio() {
		return idEstatusTituloServicio;
	}

	public void setIdEstatusTituloServicio(Integer idEstatusTituloServicio) {
		this.idEstatusTituloServicio = idEstatusTituloServicio;
	}
	...
	public String getColorSemaforoEstatus() {
		return colorSemaforoEstatus;
	}

	public void setColorSemaforoEstatus(String colorSemaforoEstatus) {
		this.colorSemaforoEstatus = colorSemaforoEstatus;
	}
}
