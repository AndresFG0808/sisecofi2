...
import com.sisecofi.admingeneral.microservicio.ProyectoRestMicroservicio;
...
@Service
@Profile("dev")
public class ProyectoRestMicroservicioDevImpl extends ProyectoRestMicroservicio {

	public final TokenUtil tokenUtil;

	public ProyectoRestMicroservicioDevImpl(RestTemplate restTemplate, @Value("${url.proyectos_base}") String url,
			TokenUtil tokenUtil) {
