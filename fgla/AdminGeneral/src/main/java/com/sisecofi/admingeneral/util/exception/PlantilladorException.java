...
public class PlantilladorException extends RuntimeException {
	...
	public PlantilladorException(DefinitionMessage definitionMessage) {
		super(definitionMessage.getMessage());
		this.definitionMessage = definitionMessage;
		this.msj = definitionMessage.getMessage();
	}

	public PlantilladorException(DefinitionMessage definitionMessage, String msj) {
		super(definitionMessage.getMessage() + msj);
		this.msj = msj;
		this.definitionMessage = definitionMessage;
	}

	public PlantilladorException(DefinitionMessage definitionMessage, Throwable throwable) {
