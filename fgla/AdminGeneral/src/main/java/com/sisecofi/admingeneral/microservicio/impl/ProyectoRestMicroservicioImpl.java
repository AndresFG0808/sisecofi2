...
@Service
@Profile("produccion")
public class ProyectoRestMicroservicioImpl extends ProyectoRestMicroservicio {

	private final HttpServletRequest request;

	public ProyectoRestMicroservicioImpl(RestTemplate restTemplate, @Value("${url.proyectos_base}") String url,
