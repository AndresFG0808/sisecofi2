...
@AllArgsConstructor
@NoArgsConstructor
public class BusquedaReintegroOtroDocumental {
	...
	@Joiny(tableJoin = "sisecofi.sscft_contrato", fieldJoin = "id_proyecto", alias = "s8", campos = {"s7.descripcion" })
	@Joiny(tableJoin = "sisecofi.sscft_archivo_otro_documento_reintegro", fieldJoin = "id_contrato", alias = "s7",specificJoin = "s8", campos = {"s7.descripcion" })	
	private BusquedaReintegroOtroDocumentalData busquedaReintegroOtroDocumentalData;
}
