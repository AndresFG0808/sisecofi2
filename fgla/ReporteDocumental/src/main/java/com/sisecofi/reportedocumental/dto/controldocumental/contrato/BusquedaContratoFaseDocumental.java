...
@AllArgsConstructor
@NoArgsConstructor
public class BusquedaContratoFaseDocumental {
	...
	@Joiny(tableJoin = "sisecofi.sscft_archivo_otro_documento_fase_contrato", fieldJoin = "id_contrato", alias = "s7",specificJoin = "s8", campos = {"s7.descripcion" })	
	private BusquedaContratoFaseDocumentalData busquedaContratoFaseDocumentalData;
}
