...
import com.sisecofi.reportedocumental.repository.financiero.ReporteTipoRepository;
...
@AllArgsConstructor
@Service
public class ReporteTipoServiceImpl extends ReporteFinancieroServiceBase implements ReporteTipoService {
    ...
    @Qualifier("mapperTipo")
    private final MapperTipo mapperTipo;

    @Override
    public PageReporteTipo obtenerReporte(ConsultaTipoDTO dto) {
        ...
        return new PageReporteTipo(dto, reporteTipoRepository.obtenerReporte(dto, true));
    }

    @Override
    public byte[] obtenerReporteExport(ConsultaTipoDTO dto) {
        ...
        return exportGenericService.exportarReporte(reporteTipoRepository.obtenerReporte(dto, false), "Reporte Financiero - Tipo", mapperTipo);
    }

    public String getMovimiento(ConsultaTipoDTO dto) {
        ...
        movimiento.put("tipos", dto.getTipos());
