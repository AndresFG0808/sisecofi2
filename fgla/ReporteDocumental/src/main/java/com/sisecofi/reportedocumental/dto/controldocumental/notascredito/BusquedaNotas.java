...
public class BusquedaNotas {
	...
	@Joiny(tableJoin = "sisecofi.sscft_notas_credito", fieldJoin = "id_dictamen", alias = "s5",specificJoin = "s3",  campos = {"s5.id_dictamen","s5.nombre","s7.descripcion" })	
	...
	private BusquedaNotasData busquedaNotasData;
}
