...
@AllArgsConstructor
@NoArgsConstructor
public class BusquedaConvenioFaseDocumental {
	...
	@Joiny(tableJoin = "sisecofi.sscft_archivo_otro_documento_fase_convenio", fieldJoin = "id_convenio_modificatorio", alias = "s7",specificJoin = "s9", campos = {"s7.descripcion" })	
	private BusquedaConvenioFaseDocumentalData busquedaConvenioFaseDocumentalData;
}
