...
@AllArgsConstructor
@NoArgsConstructor
public class BusquedaConvenioDocumental {
	...
	@Joiny(tableJoin = "sisecofi.sscfr_convenio_plantilla", fieldJoin = "id_convenio_modificatorio", alias = "s3",specificJoin = "s9", campos = {"s3.nombre","s7.descripcion" })	
	@Joiny(tableJoin = "sisecofi.sscft_carpeta_plantilla_convenio", fieldJoin = "id_convenio_plantilla", alias = "s5",specificJoin = "s3", campos = {"s5.nombre","s7.descripcion" })
	...
	@Joiny(tableJoin = "sisecofi.sscft_archivo_plantilla_convenio", fieldJoin = "id_carpeta_plantilla_convenio", alias = "s7",specificJoin = "s5", campos = {"s7.descripcion" })
	
	@Joiny(tableJoin = "sisecofi.sscfc_fase_proyecto", fieldJoin = "id_fase_proyecto", alias = "s10", campos = {"s10.nombre" },specificJoin = "s4")
	private BusquedaConvenioDocumentalData convenioDocumentalData;
}
