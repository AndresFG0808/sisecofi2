...
@AllArgsConstructor
@NoArgsConstructor
public class BusquedaReintegroDocumental {
	...
	@Joiny(tableJoin = "sisecofi.sscft_reintegros_asociados", fieldJoin = "id_contrato", alias = "s3",specificJoin = "s8", campos = {"s5.nombre","s7.descripcion" })
	@Joiny(tableJoin = "sisecofi.sscft_carpeta_plantilla_reintegro", fieldJoin = "id_reintegros_asociados", alias = "s5",specificJoin = "s3",  campos = {"s4.nombre","s7.descripcion" })	
	@Joiny(tableJoin = "sisecofi.sscft_archivo_plantilla_reintegro", fieldJoin = "id_carpeta_plantilla_reintegro", alias = "s7",specificJoin = "s5", campos = {"s7.descripcion" })
	...
	private BusquedaReintegroDocumentalData busquedaReintegroDocumentalData;
}
