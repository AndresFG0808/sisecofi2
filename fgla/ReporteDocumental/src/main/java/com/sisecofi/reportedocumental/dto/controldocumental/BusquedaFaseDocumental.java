...
@AllArgsConstructor
@NoArgsConstructor
public class BusquedaFaseDocumental {
	...
	@Joiny(tableJoin = "sisecofi.sscft_archivo_otro_documento_fase", fieldJoin = "id_proyecto", alias = "s7", campos = {"s7.descripcion" })
	private BusquedaFaseDocumentalData busquedaFaseDocumentalData;
