...
@EnableJpaRepositories(basePackages = { "com.sisecofi.libreria.comunes.*", "com.sisecofi.proveedores.*" })
@EntityScan(basePackages = { "com.sisecofi.libreria.comunes.*", "com.sisecofi.proveedores.*" })
