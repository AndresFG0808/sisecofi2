...
public class PlanTrabajoException extends RuntimeException {
	...
	public PlanTrabajoException(DefinitionMessage definitionMessage) {
		super(definitionMessage.getMessage());
		this.definitionMessage = definitionMessage;
		this.msj = definitionMessage.getMessage();
	}

	public PlanTrabajoException(DefinitionMessage definitionMessage, String msj) {
		super(definitionMessage.getMessage() + msj);
		this.msj = msj;
		this.definitionMessage = definitionMessage;
	}

	public PlanTrabajoException(DefinitionMessage definitionMessage, Throwable throwable) {
