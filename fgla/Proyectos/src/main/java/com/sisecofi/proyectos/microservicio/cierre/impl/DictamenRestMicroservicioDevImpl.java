...
@Service
@Profile("dev")
public class DictamenRestMicroservicioDevImpl extends DictamenRestMicroservicio {

	public final TokenUtil tokenUtil;
	private final BaseRestMicroservicioDevImpl baseRestUtil;

	public DictamenRestMicroservicioDevImpl(RestTemplate restTemplate, @Value("${url.devengados}") String url,
