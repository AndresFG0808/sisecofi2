...
public class PlantillaException extends RuntimeException {
	...
	public PlantillaException(DefinitionMessage definitionMessage) {
		super(definitionMessage.getMessage());
		this.definitionMessage = definitionMessage;
		this.msj = definitionMessage.getMessage();
	}

	public PlantillaException(DefinitionMessage definitionMessage, String msj) {
		super(definitionMessage.getMessage() + msj);
		this.msj = msj;
		this.definitionMessage = definitionMessage;
	}

	public PlantillaException(DefinitionMessage definitionMessage, Throwable throwable) {
