...
@Entity
@Table(name = ConstantesComunes.PREFIX_TRAB + "casoNegocio")
@Getter
@Setter
public class CasoNegocioModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Long idCasoNegocio;
    ...
    private List<CasoNegocioServicioModel> casoNegocioServicios;
	...
	public CasoNegocioModel(boolean estatus, ContratoModel contratoModel, BigDecimal[][] volumeria) {
		super();
