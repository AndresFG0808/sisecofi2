...
export function InputCurrencyCell({
  ...
  const isEditingRow = table?.getIsSomeRowsSelected();

  useEffect(() => {
    if (tipoConsumo !== "bolsa") {
      const formatMoney = formatCurrency(safeParseFloat(value), decimals, 1);
