...
import HeaderTable from '../../../../components/formInputs/HeaderTable';
...
const TablaPaginadaProveedores = ({ headers,valuesConsulta, header, data, actionFns, idKeyName, idKeyLink, handleDoubleClick, edithByUser, hasPagination, onChangeStatus, updateData, pageable }) => {
    ...
    const handleRowsPerPage = (e) => {
        ...
        console.log("handleRowsPerPage => ", elements);
        let values = {
            size: elements,
            page: 0
        };
    ...
    const getActions = (actions, id) => {
        ...
        const Component = (
            <>
                ...
                {actions.edit && (
                    <Authorization process={"PROV_MODIF"}>
                        <Action variant="edit" onClick={handleEdit(id)} />
                    </Authorization>
                )}
                            ...
                            <td key={index} className={isMoneyFormat ? 'text-end pe-4' : ''}>
                                {
                                    isMoneyFormat ? renderMoney(displayValue) :
                                        isSwitch ? (
                                            <Authorization process={"PROV_MODIF"}>
                                                <SwitchButton value={displayValue} onChange={onChangeStatus(r[idKeyName])} />
                                            </Authorization>
                                        ) :
                                    ...
                                    {chunks && chunks.length === 0 && (
                                        <tr>
                                            <td colSpan={headers.length}>
                                                <b>Sin elementos para mostrar</b>
                                            </td>
                                        </tr>
                                    )}
                                </tbody>
...
TablaPaginadaProveedores.defaultProps = {
    data: [],
    headers: [],
    idKeyName: 'id',
    footerAmount: '0',
...
export default TablaPaginadaProveedores;
