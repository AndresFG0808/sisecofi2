...
export const InfoComitesContext = createContext();

//#region Message Modal
export const InfoComitesProvider = ({ children }) => {
  ...
  return (
    <InfoComitesContext.Provider value={valueContext}>
      <>
        {children}
        <SingleBasicModal
          size="md"
