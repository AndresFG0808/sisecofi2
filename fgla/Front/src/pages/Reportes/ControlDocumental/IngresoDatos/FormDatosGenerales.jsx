...
export default function FormDatosGenerales({
  ...
  useEffect(() => {
    ...
    let { idComite,informacionArchivos } = values;
    let hasDocuments = Array.isArray(informacionArchivos) && informacionArchivos.filter(s =>  s.tamanoMb && s.tamanoMb>0).length > 0;
  ...
  useEffect(() => {
    ...
    let { idContratoConvenio, idComite } = values;
  ...
  }, [comite, contratoConvenio, values]);
