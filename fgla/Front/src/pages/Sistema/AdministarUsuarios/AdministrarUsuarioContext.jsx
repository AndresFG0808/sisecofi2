...
export const AdministrarUsuarioContext = createContext();

//#region Message Modal
export const AdministrarUsuarioProvider = ({ children }) => {
  ...
  return (
    <AdministrarUsuarioContext.Provider value={valueContext}>
      <>
        {children}
        <SingleBasicModal
          size="md"
    ...
    </AdministrarUsuarioContext.Provider>
  );
};
