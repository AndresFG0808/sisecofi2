...
import { ADMIN_CATALOGOS as MESSAGES, ADMIN_CATALOGOS_MOD } from "../../../../constants/messages";
...
import { getDataCatalog, getMetadataCatalog, saveDataCatalog, updateDataCatalog, downloadCatalog } from '../Catalogos';
...
const CatalogosGenerales = ({ catalogosOptions }) => {
    ...
    const submitChanges = (data) => {
        ...
        if (data[ID_KEY_NAME]) {
            console.log("entra if update");
            updateCatalog(data);
        } else {
            console.log("entra else alta");
            saveDataCatalog(idCatalogoBusqueda, data)
                .then((response) => {
                    ...
                    console.log("setDataTable", [...dataTable, newItem]);
    ...
    const handleBuscar = () => {
        ...
        getDataCatalog(idCatalogoBusqueda)
            ...
            .catch((error) => {
                ...
                } else if (errorMessage.includes(MESSAGES.MSG002)) {
                    showMessage(errorMessage);
                    setShowTable(true);
                }
                else {
    ...
    return (
        ...
        <Container className='mt-3 px-0'>
            ...
            <Accordion title="Catálogos generales">
                <Row>
                    <Col md={4}>
                        <Select
                            label="Catálogo*:"
...
export default CatalogosGenerales;